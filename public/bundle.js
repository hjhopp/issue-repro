(function () {
    ...
    ***************************************************************************** */
    ...
    Object.defineProperty(fsm, "__esModule", { value: true });
    var useMachine_1 = fsm.useMachine = void 0;
    var fsm_1 = require$$0;
    var svelte_1 = svelte;
    var store_1 = store;
    function useMachine(machine, options) {
        ...
        (0, svelte_1.onDestroy)(service.stop);
    ...
    useMachine_1 = fsm.useMachine = useMachine;
    ...
    useMachine_1(viewMachine);

    /* client\Thing.svelte generated by Svelte v3.52.0 */

    const { console: console_1 } = globals;
    const file = "client\\Thing.svelte";
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Thing> was created with unknown prop '${key}'`);
    	});
